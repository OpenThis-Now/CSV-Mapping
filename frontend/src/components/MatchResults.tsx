...
function Badge({ children, tone = "gray" }: { children: React.ReactNode; tone?: "gray" | "green" | "yellow" | "red" | "blue" | "purple" }) {
          ...
          {sortedResults.map((r) => (
            <tr key={r.id} className="hover:bg-gray-50/60">
              ...
              <td className="px-3 py-4 align-top">
                ...
                {r.decision === "ready_for_db_import" && <Badge tone="purple">Ready for DB import</Badge>}

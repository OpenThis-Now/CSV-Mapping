...
export default function ExportPage({ projectId }: { projectId: number }) {
  ...
  const exportOptions = [
    ...
    {
      key: "ready_for_db_import",
      title: "Ready for DB import",
      desc: "Exports products ready for database import with supplier mapping",
      badge: { label: "Ready for DB import", tone: "violet" },
      toneBg: "bg-violet-50",

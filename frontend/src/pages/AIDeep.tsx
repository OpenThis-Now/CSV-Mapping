                          ...
                          {expanded.has(item.uniqueKey) && item.details && (
                            <div className="mt-4 space-y-3 border-t pt-3 text-sm">
                              ...
                              <div className="flex gap-3 mt-3">
                                <button 
                                  className="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium bg-slate-100 hover:bg-green-100 hover:text-green-700 transition-colors"
                                  onClick={() => handleApproveSuggestion(item.details.suggestion)}
                                  title="Select this match"
                                >
                                ...
                                <button 
                                  className="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium border hover:bg-red-100 hover:text-red-700 hover:border-red-200 transition-colors"
